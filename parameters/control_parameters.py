...
#----------yaw damper-------------
yaw_damper_p_wo = 0.45 # 0.45  # (old) 1/0.5
yaw_damper_kr = 0.196 # 0.2  # (old) 0.5
...
wn_airspeed_throttle = 5.0 #3.0
zeta_airspeed_throttle = 2.5 #2  
